...
def aarch32_UXTB16_T1_A(core, regex_match, bitdiffs):
    ...
    def aarch32_UXTB16_T1_A_exec():
        ...
        if core.ConditionPassed(cond):
            ...
            core.R[d] = core.SetField(core.R[d],15,0,core.ZeroExtend(core.Field(rotated,7,0), 16));
            core.R[d] = core.SetField(core.R[d],31,16,core.ZeroExtend(core.Field(rotated,23,16), 16));
        else:
