...
log = logging.getLogger('Mnem.UHSUB16')
...
def aarch32_UHSUB16_T1_A(core, regex_match, bitdiffs):
    ...
    def aarch32_UHSUB16_T1_A_exec():
        ...
        if core.ConditionPassed(cond):
            diff1 = core.UInt(core.Field(core.R[n],15,0)) - core.UInt(core.Field(core.R[m],15,0));
            diff2 = core.UInt(core.Field(core.R[n],31,16)) - core.UInt(core.Field(core.R[m],31,16));
            core.R[d] = core.SetField(core.R[d],15,0,core.Field(diff1,16,1));
            core.R[d] = core.SetField(core.R[d],31,16,core.Field(diff2,16,1));
        else:
