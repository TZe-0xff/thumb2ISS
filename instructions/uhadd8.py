...
log = logging.getLogger('Mnem.UHADD8')
...
def aarch32_UHADD8_T1_A(core, regex_match, bitdiffs):
    ...
    def aarch32_UHADD8_T1_A_exec():
        ...
        if core.ConditionPassed(cond):
            ...
            core.R[d] = core.SetField(core.R[d],7,0,core.Field(sum1,8,1));
            core.R[d] = core.SetField(core.R[d],15,8,core.Field(sum2,8,1));
            core.R[d] = core.SetField(core.R[d],23,16,core.Field(sum3,8,1));
            core.R[d] = core.SetField(core.R[d],31,24,core.Field(sum4,8,1));
        else:
