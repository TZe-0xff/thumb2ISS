...
log = logging.getLogger('Mnem.UHADD16')
...
def aarch32_UHADD16_T1_A(core, regex_match, bitdiffs):
    ...
    def aarch32_UHADD16_T1_A_exec():
        ...
        if core.ConditionPassed(cond):
            sum1 = core.UInt(core.Field(core.R[n],15,0)) + core.UInt(core.Field(core.R[m],15,0));
            sum2 = core.UInt(core.Field(core.R[n],31,16)) + core.UInt(core.Field(core.R[m],31,16));
            core.R[d] = core.SetField(core.R[d],15,0,core.Field(sum1,16,1));
            core.R[d] = core.SetField(core.R[d],31,16,core.Field(sum2,16,1));
        else:
