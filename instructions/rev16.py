...
log = logging.getLogger('Mnem.REV16')
...
def aarch32_REV16_T1_A(core, regex_match, bitdiffs):
    ...
    def aarch32_REV16_T1_A_exec():
        ...
        if core.ConditionPassed(cond):
            result = 0;
            result = core.SetField(result,31,24,core.Field(core.R[m],23,16));
            result = core.SetField(result,23,16,core.Field(core.R[m],31,24));
            result = core.SetField(result,15,8,core.Field(core.R[m],7,0));
